...
const levelStyles = {
  ...
  h4: 'text-lg font-bold leading-6 tracking-tight text-gray-900 dark:text-gray-100 sm:text-xl sm:leading-7 md:text-3xl md:leading-9 mb-2 md:mb-4',
...
const Heading = ({ level, className, children }: HeadingProps) => {
  ...
  const defaultClassName = levelStyles[level] + (className ? ` ${className}` : '');
