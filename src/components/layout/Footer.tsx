      ...
      <div className="grid grid-cols-2 gap-y-4 py-10 md:py-16 md:grid-cols-4 md:gap-0">
        ...
        <div className="flex flex-col text-sm text-gray-500 dark:text-gray-300 items-center md:items-end">
          <div>
            ...
            <Link className="block mb-1 hover:underline" href="/about">
              About
            </Link>
            <Link className="block mb-1 hover:underline" href="/blog">
              Blog
            </Link>
          </div>
        </div>
        <div className="flex flex-col text-sm text-gray-500 dark:text-gray-300 items-center md:items-end">
          <div>
            ...
            <Link
              className="relative flex items-center mb-1 hover:underline"
              target="_blank"
              href="https://www.linkedin.com/in/%E6%9F%8F%E9%88%9E-%E9%BB%83-731848154/"
            >
            ...
            <Link
              className="relative flex items-center mb-1 hover:underline"
              target="_blank"
              href="https://github.com/testBP0612"
            >
